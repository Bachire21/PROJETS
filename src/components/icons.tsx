...
export function GraduationIcon({ className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M6.5 11.5v4.8c0 1 2.5 2.7 5.5 2.7s5.5-1.7 5.5-2.7v-4.8" />
      <path d="M22 9v5" />
    </svg>
  );
}
...
export function QuoteIcon({ className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M10.4 5.4C6.8 7.2 4.5 10.1 4.5 14c0 2.6 1.6 4.6 3.9 4.6 2 0 3.5-1.5 3.5-3.5 0-1.9-1.3-3.3-3.2-3.3-.3 0-.7.1-.8.1.3-1.8 2-4 4.5-5.3L10.4 5.4Zm9 0c-3.6 1.8-5.9 4.7-5.9 8.6 0 2.6 1.6 4.6 3.9 4.6 2 0 3.5-1.5 3.5-3.5 0-1.9-1.3-3.3-3.2-3.3-.3 0-.7.1-.8.1.3-1.8 2-4 4.5-5.3L19.4 5.4Z" />
    </svg>
  );
}
...
export function QuestionIcon({ className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M9.3 9.2a2.75 2.75 0 1 1 3.6 2.65c-.7.28-1.15.9-1.15 1.65" />
      <path d="M11.8 17h.02" />
    </svg>
  );
}
...
export function SparkleIcon({ className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M12 2.5c.5 4.6 2.4 8.4 5.2 9.5-2.8 1.1-4.7 4.9-5.2 9.5-.5-4.6-2.4-8.4-5.2-9.5 2.8-1.1 4.7-4.9 5.2-9.5ZM19 13c.25 2.3 1.2 4.2 2.6 4.75-1.4.55-2.35 2.45-2.6 4.75-.25-2.3-1.2-4.2-2.6-4.75 1.4-.55 2.35-2.45 2.6-4.75Z" />
    </svg>
  );
}
